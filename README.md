...
| :--- | :--- | :--- |
| **🕹️ Principal gestor de Contenido (Uploader)** | **Raxxor** | Se encarga de **conseguir, empaquetar, subir** los archivos de los juegos (en formato ZIP/RAR portable) a plataformas de alojamiento y proporcionar los enlaces de descarga. |
